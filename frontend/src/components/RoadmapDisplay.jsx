          ...
          >
            ...
            <div className="glass-card p-5 flex-1 hover:border-slate-700 transition-colors">
              <div className="flex items-center justify-between mb-2">
                <h3 className="font-semibold text-lg text-white">Day {day.day_number}: {day.topic}</h3>
                <Calendar size={16} className="text-slate-500" />
              </div>
              <p className="text-slate-400 text-sm leading-relaxed">{day.content}</p>
              
              {day.tasks && (
                <div className="mt-4 space-y-2">
                  <p className="text-xs font-bold text-slate-500 uppercase tracking-wider">Daily Tasks</p>
